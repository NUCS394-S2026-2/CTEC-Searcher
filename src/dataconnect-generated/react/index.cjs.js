const { listCourseOfferingsRef, getCourseOfferingRef, createCourseOfferingRef, createQuestionRef, connectorConfig } = require('../index.cjs.js');
...
exports.useGetCourseOffering = function useGetCourseOffering(dcOrVars, varsOrOptions, options) {
